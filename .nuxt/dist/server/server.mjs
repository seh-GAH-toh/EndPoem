...
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, withHttps, parseQuery, withTrailingSlash, withoutTrailingSlash } from "ufo";
import "destr";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-17459f1b.js").then(function(n) {
      return n.i;
    }).then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><main class="leading-normal p-10 sm:p-20 md:p-40 2xl:p-80 fade-in-fwd font-[&#39;Open_Sans&#39;] flex flex-col gap-10 min-h-screen w-full items-center justify-center bg-[#FBFBFB] dark:bg-[#29292a] dark:text-[#FBFBFB] text-[#29292a]"><article><q class="text-xl">${ssrInterpolate(quotesList[Math.floor(Math.random() * quotesList.length)])}</q><address class="text-right text-lg">Douglas Adams</address></article></main><footer class="z-10 w-full absolute bottom-0 py-5 text-center left-0 px-10 sm:px-20"><p> It appears that an error has occurred. Kindly navigate back to the main page or click `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<strong${_scopeId}>here</strong>`);
          } else {
            return [
              createVNode("strong", null, "here")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(` to proceed. </p></footer><!--]-->`);
    };
  }
});
