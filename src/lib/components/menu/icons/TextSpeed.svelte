...
<li class="flex aspect-square w-6">
	...
	>
		<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
			...
			><rect width="24" height="24" fill="currentColor" mask="url(#lineMdSpeed0)" /></svg
		>
	</button>
</li>
