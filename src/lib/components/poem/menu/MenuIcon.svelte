<script>
	let { isMenuOpen, firsApareance } = $props();
</script>

{#if !isMenuOpen && firsApareance}
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-full"
		><g
			fill="none"
			stroke="currentColor"
			stroke-dasharray="16"
		...
		></svg
	>
{:else if !isMenuOpen && !firsApareance}
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-full"
		><path
			fill="none"
			stroke="currentColor"
