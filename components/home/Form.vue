...
<template>
  ...
  >
    <div
      ...
      :class="
        name.length >= 2
          ? 'border-b-[#29292a] dark:border-b-[#FBFBFB]'
          : 'border-b-[#29292a]/50 dark:border-b-[#FBFBFB]/50'
      "
    >
      <input
        id="name"
      ...
      <button
        ...
        class="h-full fill-[#29292a] px-6 outline-none transition-all duration-300 ease-in-out focus:-translate-y-1 disabled:cursor-not-allowed disabled:fill-[#29292a]/50 dark:fill-[#FBFBFB] dark:disabled:fill-[#FBFBFB]/50"
      >
        <svg
    ...
    <label
      for="name"
      :class="name.length != 0 ? '-top-2' : 'top-4'"
