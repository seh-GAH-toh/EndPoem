<template>
  ...
  >
    ...
    <p class="text-sm md:text-base 2xl:text-lg">
      ...
      >
      by its creator,
      <a class="underline" href="https://www.juliangough.com" tabindex="0"
        >Julian Gough</a
      >. For insights into his decision, I highly recommend checking out his
      <a
        class="underline"
        href="https://theeggandtherock.substack.com/p/i-wrote-a-story-for-a-friend"
        tabindex="0"
        >blog post</a
      >
    ...
    <p class="text-sm md:text-base 2xl:text-lg">
      ...
      <a class="underline" href="https://github.com/ArthurSegato" tabindex="0"
        >Arthur Segato</a
      >
      ...
      <a
        class="underline"
        href="https://donate.stripe.com/9AQbMl1Pt5DV4i4288"
        tabindex="0"
        >Stripe</a
    ...
    <p class="text-sm md:text-base 2xl:text-lg">
      ...
      <a
        class="underline"
        href="mailto:github.reentry594@passinbox.com"
        tabindex="0"
        >github.reentry594@passinbox.com</a
      ...
      <a
        class="underline"
        href="https://github.com/ArthurSegato/Website-TheEndPoem"
        tabindex="0"
        >Github repository</a
      >.
    </p>
    <p class="text-sm md:text-base 2xl:text-lg">
      Icons by
      <a class="underline" href="https://icons.getbootstrap.com" tabindex="0"
        >Bootstrap Icons</a
      >,
      <a
        class="underline"
      ...
      <a
        class="underline"
        href="https://fonts.google.com/specimen/Nothing+You+Could+Do"
        tabindex="0"
      ...
      <a
        class="underline"
        href="https://codepen.io/himalayasingh/pen/KOdJPM"
        tabindex="0"
        >Menu button</a
      >.
    </p>
